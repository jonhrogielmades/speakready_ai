 ...
 */
 ...
 'rerank_server_timeout' => env('QUESTION_RERANK_SERVER_TIMEOUT', 3),
 ...
 'timeout' => env('QUESTION_RECOMMENDER_TIMEOUT', 120),
 ...
 'trained_model_timeout' => env('QUESTION_TRAINED_MODEL_TIMEOUT', 120),
 'trained_model_process_fallback_enabled' => env('QUESTION_TRAINED_MODEL_PROCESS_FALLBACK', false),
 'ai_provider_rerank_enabled' => env('QUESTION_AI_PROVIDER_RERANK_ENABLED', true),
 'ai_provider_timeout' => env('QUESTION_AI_PROVIDER_RERANK_TIMEOUT', 8),
 ...
 'candidate_pool_limit' => env('QUESTION_RECOMMENDER_CANDIDATE_POOL_LIMIT', 120),
 'candidate_pool_multiplier' => env('QUESTION_RECOMMENDER_CANDIDATE_POOL_MULTIPLIER', 8),
 ],
