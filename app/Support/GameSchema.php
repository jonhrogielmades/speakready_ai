...
class GameSchema
{
 ...
 && self::hasColumns('game_answers', self::gameAnswerColumns());
 }
 ...
 $table->string('response_mode')->default('voice');
 ...
 $missing = self::missingColumns('game_answers', self::gameAnswerColumns());
 ...
 * @return array<int, string>
 */
 private static function gameAnswerColumns(): array
 {
 return [
 'game_session_id',
 'question_index',
