...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table($tableName, function (Blueprint $table) use ($tableName) {
            ...
            if (! Schema::hasColumn($tableName, 'learning_objective')) {
                $table->text('learning_objective')->nullable();
            }

            if (! Schema::hasColumn($tableName, 'success_criteria')) {
                $table->text('success_criteria')->nullable();
            }

            if (! Schema::hasColumn($tableName, 'retry_hint')) {
    ...
    {
        // Repair migration: keep existing production learning guidance data on rollback.
    }
