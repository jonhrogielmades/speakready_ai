...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/mobile/admin/notifications.css?v=3') }}" data-page-style="admin-notifications">
@endpush

@section('content')

<div class="db-section active admin-notifications-shell" id="sec-admin-notifications" data-activities-url="{{ url('/admin/api/activities') }}">
    @if(session('success'))
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3 admin-notifications-header">
        ...
        <div class="admin-notifications-header-actions">
            <button type="button" class="btn-premium admin-notifications-send-btn" data-bs-toggle="modal" data-bs-target="#sendNotificationModal">
    ...
    <!-- Stats Row -->
    <div class="row g-3 mb-4 admin-notifications-stats-row">
        <div class="col-12 col-md-3">
            <div class="premium-card text-center p-4 h-100 admin-notification-stat-card">
        ...
        <div class="col-12">
            <div class="premium-card mb-4 activity-history-card">
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                    ...
                    @if($activityCount > 0)
                    <div class="d-flex flex-wrap gap-2 admin-notification-activity-actions">
                ...
                <div class="table-responsive" id="adminActivityTableWrapper">
                    <table class="table custom-table mb-0 w-100 activity-history-table" id="adminActivityTable">
                        <thead>
                            <tr>
                                <th>User</th>
                                <th>Activity</th>
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $isNew ? 'activity-unread-row' : '' }}">
                                ...
                                <td data-label="Actions" class="text-end admin-notification-action-cell">
                            ...
                            @empty
                            <tr><td colspan="6" class="text-center text-muted py-4 admin-notifications-empty-cell">No activity logs have been recorded yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>

                <div class="mt-4 d-flex justify-content-center admin-notifications-pagination">
                    {{ $activities->links('pagination::bootstrap-5') }}
                </div>
            </div>

            <div class="premium-card mb-4 broadcast-history-card">
                <h6 class="fw-bold mb-4 admin-broadcast-history-title">Broadcast History</h6>
                <div class="table-responsive" id="adminBroadcastTableWrapper">
                    <table class="table custom-table mb-0 w-100" id="adminBroadcastTable">
                        <thead>
                            <tr>
                                <th>Title</th>
                                <th>Message</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Message" class="admin-notification-message-cell" style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                ...
                                <td data-label="Actions" class="text-end admin-notification-action-cell">
                                    <form action="{{ route('admin.notifications.destroy', $announcement->id) }}" method="POST" class="d-inline admin-notification-row-action-form" onsubmit="return confirm('Delete this record? Note: This will not delete the actual notifications already delivered to users.');">
                                        @csrf
                                        @method('DELETE')
                            ...
                            @empty
                            <tr><td colspan="6" class="text-center text-muted py-4 admin-notifications-empty-cell">No notifications have been sent yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
...
<div class="modal fade" id="sendNotificationModal" tabindex="-1" aria-labelledby="sendNotificationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered admin-notification-modal-dialog">
        <div class="modal-content admin-notification-modal-content" style="background: var(--sf, #1e1e2d); border: 1px solid var(--bd, rgba(255,255,255,0.1)); border-radius: 16px;">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold" id="sendNotificationModalLabel">New Notification</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="filter: invert(1);"></button>
            </div>
            <form action="{{ route('admin.notifications.store') }}" method="POST" class="admin-send-notification-form">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row admin-notification-modal-grid">
                ...
                <div class="modal-footer border-0 pt-0 admin-notification-modal-footer">
