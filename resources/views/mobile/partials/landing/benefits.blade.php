                  ...
                  <div class="col-lg-5 rv">
                     <ul class="list-unstyled d-flex flex-column gap-3">
                        ...
                        <li class="d-flex align-items-start gap-3">
                           ...
                           <div><h4 class="fs-6 fw-bold mb-1">Practice Anytime, Anywhere</h4><p style="font-size:.85rem;color:var(--tx2)">24/7 access to your personal interview coach.</p></div>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                        ...
                        <li class="d-flex align-items-start gap-3">
                           ...
                           <div><h4 class="fs-6 fw-bold mb-1">Learn local Interview Techniques</h4><p style="font-size:.85rem;color:var(--tx2)">Master STAR, role-fit answers, salary expectations, and local HR screening strategies.</p></div>
                        </li>
                        <li class="d-flex align-items-start gap-3">
