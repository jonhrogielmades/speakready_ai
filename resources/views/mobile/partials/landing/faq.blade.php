                     ...
                     <div class="accordion acco" id="faqAcc">
                        ...
                        <div class="accordion-item">
                           ...
                           <div id="f2" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                              <div class="accordion-body">SpeakReady evaluates relevance, clarity, professionalism, applicable STAR evidence, and job evidence with a versioned rubric. Delivery and optional body-language detection notes are not readiness scores and do not infer confidence, honesty, or personality.</div>
                           </div>
                        </div>
                        <div class="accordion-item">
