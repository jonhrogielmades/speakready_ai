            ...
            <div class="container">
               ...
               <div class="row g-4">
                  ...
                  <div class="col-md-3 col-sm-6 rv" style="transition-delay:.3s">
                     <div class="gc p-4 h-100 text-center feature-card">
                        <div class="ftico mx-auto mb-3" style="width:50px;height:50px;display:flex;align-items:center;justify-content:center;border-radius:12px;background:rgba(6,182,212,.15);color:#06b6d4"><i class="fa-solid fa-robot fa-lg"></i></div>
                  ...
                  <div class="col-md-3 col-sm-6 rv" style="transition-delay:.35s">
                     <div class="gc p-4 h-100 text-center feature-card">
                        <div class="ftico mx-auto mb-3" style="width:50px;height:50px;display:flex;align-items:center;justify-content:center;border-radius:12px;background:rgba(34,197,94,.15);color:#22c55e"><i class="fa-solid fa-clipboard-check fa-lg"></i></div>
