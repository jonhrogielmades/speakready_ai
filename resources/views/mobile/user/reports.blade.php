...
@php
 ...
 $reportFooterText = $systemSettings['rep_footer'] ?? 'Generated by SpeakReady AI System.';
 $reportSignatureText = $systemSettings['rep_signature'] ?? 'Approved By';
...
<div class="db-section active animate-fade-up" id="portfolioReport">
 ...
 @if($hasScoreData)
 <div class="print-card report-print-footer mb-4" style="background:var(--sf);border:1px solid var(--bd);border-radius:18px;padding:22px;">
 <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
 <p style="color:var(--tx3);margin:0;">{{ $reportFooterText }}</p>
 <div style="min-width:180px;text-align:center;">
 <div style="border-top:1px solid var(--bd);padding-top:8px;color:var(--tx);font-weight:800;">{{ $reportSignatureText }}</div>
 </div>
 </div>
 </div>
 @endif
