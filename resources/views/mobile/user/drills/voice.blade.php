...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/mobile/user/drills/voice.css?v=1') }}" data-page-style="user-drills-voice">
<link rel="stylesheet" href="{{ asset('css/mobile/user/drills/voice-2.css?v=4') }}" data-page-style="user-drills-voice-2">
@endpush
