...
<div class="db-section active animate-fade-up feedback-shell">
 ...
 <p class="feedback-subtitle" style="color:rgba(248,251,255,.92)!important;-webkit-text-fill-color:rgba(248,251,255,.92)!important;">See the evidence behind each score, how reliable it is, and what to practice next.</p>
 </div>
 </div>
