...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/desktop/interview/session.css?v=31') }}" data-page-style="interview-session">
@endpush
...
<div class="db-section active" id="sec-interview-session">
 ...
 const speechOptions = typeof options === 'boolean'? { boundaryAware: options }: (options || {});
 ...
 const exitPromise = shouldExitBrowser && document.fullscreenElement && document.exitFullscreen? document.exitFullscreen().catch(() => {}): Promise.resolve();
 ...
 pauseBtn.innerHTML = isIdle? '<i class="fa-solid fa-microphone"></i>': (isPaused? '<i class="fa-solid fa-play"></i>': '<i class="fa-solid fa-pause"></i>');
