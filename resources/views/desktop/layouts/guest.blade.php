...
<!-- ======================== LANDING PAGE ======================== -->
      <div id="landing">
         ...
         @include('desktop.partials.user-command-palette', ['guestQuickNavigation' => true])
         ...
         <section id="hero">
            ...
            <div class="aur aur-a" style="bottom:-80px;left:45%;transform:translateX(-50%);opacity:.4"></div>
             <div class="container hero-home-container position-relative" style="z-index:2">
                @php
                   $previewReadiness = 85;
                   $previewInterviews = 6;
                   $previewClarity = 92;
                   $previewGrammar = 95;
                @endphp
                <div class="row hero-home-layout align-items-center g-4">
                  <div class="col-xl-5 col-lg-5 col-md-10 hero-home-copy text-center text-lg-start">
                     ...
                     <p class="hero-home-copy-text afu" style="font-size:clamp(.95rem,1.8vw,1.2rem);color:var(--tx2);margin-bottom:36px;animation-delay:.2s">SpeakReady AI offers simulated mock interviews, personalized feedback, and comprehensive coaching to help you land your dream opportunity.</p>
                     <div class="hero-cta-row d-flex align-items-center justify-content-center justify-content-lg-start gap-3 flex-wrap afu" style="animation-delay:.28s">
                     ...
                     <div class="hero-tech-card mt-4 mb-0 afu text-center text-lg-start" style="animation-delay:.4s">
                        ...
                        <div class="d-flex align-items-center justify-content-center justify-content-lg-start gap-4 flex-wrap tech-icons" style="color:var(--hero-tech-color, #000000); font-size:1.5rem;">
                  ...
                  <div class="col-xl-7 col-lg-7 col-md-11 hero-demo-preview-col">
                     ...
                     <div class="desktop-demo-preview-row mt-3 mb-1">
                        <div class="adi">
                     <div class="swiper desktopPreviewSwiper desktop-preview-image-swiper" aria-label="SpeakReady AI desktop demo preview carousel">
                        @php
                           $desktopPreviewSlides = [
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-overview.png',
                                 'alt' => 'SpeakReady AI desktop overview preview',
                                 'kicker' => 'Overview',
                                 'title' => 'Dashboard readiness at a glance.',
                                 'text' => 'View readiness, practice stats, skill radar, trends, and next actions from the desktop dashboard.',
                              ],
                              [
                              ...
                              [
                                 ...
                                 'kicker' => 'Modules',
                                 'title' => 'Open guided preparation modules.',
                                 'text' => 'Browse recommended lessons, learning paths, and topic filters for organized interview preparation.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-voice-rehearsal.png',
                                 'alt' => 'SpeakReady AI desktop voice rehearsal preview',
                                 'kicker' => 'Voice Rehearsal',
                                 'title' => 'Practice answers out loud.',
                                 'text' => 'Record responses, check pace, spot fillers, and review instant speaking feedback on desktop.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-missions.png',
                                 'alt' => 'SpeakReady AI desktop mission mode preview',
                                 'kicker' => 'Missions',
                                 'title' => 'Generate real-life practice tasks.',
                                 'text' => 'Turn workplace, panel, scholarship, and interview situations into scored mission practice.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-challenges.png',
                                 'alt' => 'SpeakReady AI desktop challenges preview',
                                 'kicker' => 'Challenges',
                                 'title' => 'Build skill through challenge journeys.',
                                 'text' => 'Track levels, XP, lives, streaks, accuracy, and challenge checklists in a gamified flow.',
                              ],
                              [
                              ...
                              [
                                 ...
                                 'alt' => 'SpeakReady AI desktop feedback center preview',
                                 'kicker' => 'Feedback',
                                 'title' => 'Review coaching and next steps.',
                                 'text' => 'See feedback summaries, priority recommendations, answer coaching, and searchable history.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-reports.png',
                                 'alt' => 'SpeakReady AI desktop interview reports preview',
                                 'kicker' => 'Reports',
                                 'title' => 'Open scored interview reports.',
                                 'text' => 'Generate, review, and export scored interview reports once practice data is available.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-personal-mastery.png',
                                 'alt' => 'SpeakReady AI desktop personal mastery preview',
                                 'kicker' => 'Personal Mastery',
                                 'title' => 'Track private interview growth.',
                                 'text' => 'Compare baseline, personal best, latest assessment, practice streak, and career track mastery.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-account.png',
                                 'alt' => 'SpeakReady AI desktop account management preview',
                                 'kicker' => 'Account',
                                 'title' => 'Manage profile and security.',
                                 'text' => 'Update profile details, target position, picture upload, password fields, and account settings.',
                              ],
                              [
                                 'image' => 'img/desktop-preview/desktop-preview-notifications.png',
                                 'alt' => 'SpeakReady AI desktop notifications preview',
                                 'kicker' => 'Notifications',
                                 'title' => 'Scan alerts and activity history.',
                        ...
                        <div class="swiper-wrapper">
                           @foreach($desktopPreviewSlides as $slide)
                              ...
                              <div class="swiper-slide desktop-preview-image-slide">
                                 <img
                                    class="desktop-preview-shell-img"
                                    ...
                                    decoding="async"
                                 >
                                 <div class="desktop-preview-copy">
                                    <div class="desktop-preview-copy-kicker"><span>{{ $loop->iteration }}</span> {{ $slide['kicker'] }}</div>
                                    <div class="desktop-preview-copy-body">
                                       <h3 class="desktop-preview-copy-title">{{ $slide['title'] }}</h3>
                                       <p class="desktop-preview-copy-text">{{ $slide['text'] }}</p>
                                    </div>
                                 </div>
                              </div>
                           @endforeach
                        </div>
                        <div class="swiper-pagination desktop-preview-pagination"></div>
                        <button type="button" class="desktop-preview-autoplay-toggle" aria-label="Pause desktop demo preview">
                           <i class="fa-solid fa-pause" aria-hidden="true"></i>
                        </button>
                        <button type="button" class="swiper-button-next desktop-preview-next" aria-label="Next desktop demo preview"></button>
                        <button type="button" class="swiper-button-prev desktop-preview-prev" aria-label="Previous desktop demo preview"></button>
                      </div>
                   </div>
                </div>
                  </div>
                 ...
                 <div class="row justify-content-center mt-3 mb-3 d-none" aria-hidden="true">
                     ...
                     <div class="accordion acco" id="faqAcc">
                        ...
                        <div class="accordion-item">
                           ...
                           <div id="f2" class="accordion-collapse collapse" data-bs-parent="#faqAcc">
                               <div class="accordion-body">SpeakReady evaluates answer relevance, clarity, professionalism, applicable STAR evidence, and job evidence using a versioned rubric. Delivery signals and optional body-language detection notes do not affect readiness scores and do not infer confidence, honesty, or personality.</div>
                           </div>
                        </div>
                        <div class="accordion-item">
      ...
      <script>
         ...
         $(document).ready(function() {
             ...
             if(typeof Swiper !== 'undefined') {
                 document.querySelectorAll(".desktopPreviewSwiper").forEach(function(previewEl) {
                     const reduceMotion = window.matchMedia("(prefers-reduced-motion: reduce)").matches;
                     const previewSwiper = new Swiper(previewEl, {
                         ...
                         pagination: {
                             el: previewEl.querySelector(".desktop-preview-pagination"),
                             clickable: true,
                         },
                         navigation: {
                             nextEl: previewEl.querySelector(".desktop-preview-next"),
                             prevEl: previewEl.querySelector(".desktop-preview-prev"),
                         },
                     });

                     const hydrateNearbyPreviewImages = function() {
                         const previewImages = Array.from(previewEl.querySelectorAll(".desktop-preview-shell-img[data-src]"));
                         if (!previewImages.length) return;

                         const totalSlides = new Set(
                             Array.from(previewEl.querySelectorAll(".desktop-preview-shell-img[data-preview-index]"))
                     ...
                     const autoplayToggle = previewEl.querySelector(".desktop-preview-autoplay-toggle");
                     if (autoplayToggle) {
                         const icon = autoplayToggle.querySelector("i");

                         if (reduceMotion) {
                             autoplayToggle.classList.add("is-paused");
                             autoplayToggle.setAttribute("aria-label", "Play desktop demo preview");
                         ...
                         autoplayToggle.addEventListener("click", function() {
                             ...
                             if (paused) {
                                 ...
                                 autoplayToggle.setAttribute("aria-label", "Pause desktop demo preview");
      ...
      <script>
         ...
         document.getElementById('heroInstallBtn')?.addEventListener('click', triggerInstall);
          ...
          document.getElementById('pwa-btn-no')?.addEventListener('click', () => {
             ...
             if (document.getElementById('pwa-install-prompt')?.dataset.mode !== 'message') {
