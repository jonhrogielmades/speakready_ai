...
<div class="db-section active">
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            ...
            <p style="font-size:.875rem;color:var(--tx3);margin:0">{{ $category->description ?? 'interview category details and analytics' }}</p>
        </div>
        <div>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div style="background:var(--sf);border:1px solid var(--bd);border-radius:18px;padding:20px;">
                <h6 style="color:var(--tx3);font-size:.85rem;margin-bottom:8px">Total Interview Questions</h6>
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <div style="background:var(--sf);border:1px solid var(--bd);border-radius:18px;padding:24px;height:100%;">
                <h5 style="color:var(--tx);font-size:1.1rem;margin-bottom:20px;font-weight:600">Interview Performance Over Time</h5>
                <canvas id="barChart" style="max-height: 300px;"></canvas>
            </div>
        </div>
        <div class="col-md-4">
            <div style="background:var(--sf);border:1px solid var(--bd);border-radius:18px;padding:24px;height:100%;">
                <h5 style="color:var(--tx);font-size:1.1rem;margin-bottom:20px;font-weight:600">Interview Question Types</h5>
    ...
    <div style="background:var(--sf);border:1px solid var(--bd);border-radius:18px;padding:24px;overflow-x:auto;">
        <div class="d-flex justify-content-between mb-3">
            <h5 style="color:var(--tx);font-size:1.1rem;margin:0;font-weight:600">Interview Questions in this Category</h5>
            <a href="{{ route('admin.questions') }}" class="btn btn-sm btn-outline-primary">Manage Interview Questions</a>
        </div>
        <table class="table table-dark table-hover mb-0" style="background:transparent;--bs-table-bg:transparent;--bs-table-color:var(--tx)">
            <thead>
                <tr>
                    ...
                    <th style="border-bottom:1px solid var(--bd);color:var(--tx3);font-size:.8rem;font-weight:600">Interview Question Text</th>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center" style="border-bottom:none;padding:20px;color:var(--tx3)">No interview questions found in this category.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
