...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/desktop/admin/sessions/review.css?v=1') }}" data-page-style="admin-sessions-review">
@endpush
...
<div class="db-section active">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h4 class="fw-bold mb-1 mt-2">Interview Q&A Review & AI Feedback</h4>
    ...
    <div class="premium-card mb-4" style="border-left: 4px solid #3b82f6;">
        <h6 class="fw-bold mb-3"><i class="fa-solid fa-robot me-2 text-primary"></i>AI Overall Interview Feedback</h6>
        <div class="row g-4">
            <div class="col-md-6">
                <div class="mb-3">
    ...
    <div class="alert alert-warning" style="background:rgba(251,191,36,0.1);color:#fbbf24;border:1px solid rgba(251,191,36,0.3);">
        <i class="fa-solid fa-circle-exclamation me-2"></i> Overall AI feedback has not been generated for this interview session.
    </div>
    @endif
    ...
    @forelse($session->answers as $index => $answer)
        <div class="qa-box {{ $index === 0 ? 'open' : '' }}">
            ...
            <div class="qa-body">
                <div class="row g-4">
                    <div class="col-lg-6">
                        <label style="font-size:0.8rem;color:var(--tx3);text-transform:uppercase;font-weight:600;">Interview Question Text</label>
