...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/desktop/admin/sessions/index.css?v=1') }}" data-page-style="admin-sessions-index">
@endpush
...
<div class="db-section active">
    ...
    <div class="row g-3 mb-4 session-stat-grid">
        <div class="col-6 col-md-4 col-xl-2">
            <div class="premium-card session-stat-card text-center p-3 h-100">
                ...
                <div style="font-size:0.75rem;color:var(--tx3);text-transform:uppercase;letter-spacing:0.5px;">Total Interview Sessions</div>
            </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
            <div class="premium-card session-stat-card text-center p-3 h-100">
        ...
        <div class="col-6 col-md-4 col-xl-2">
            <div class="premium-card session-stat-card text-center p-3 h-100">
                ...
                <div style="font-size:0.75rem;color:var(--tx3);text-transform:uppercase;letter-spacing:0.5px;">Completed Interviews</div>
            </div>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
            <div class="premium-card session-stat-card text-center p-3 h-100">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-3">
            <div class="premium-card h-100">
                <h6 class="fw-bold mb-4">Most Used Interview Category</h6>
                @if($mostUsedCategory)
