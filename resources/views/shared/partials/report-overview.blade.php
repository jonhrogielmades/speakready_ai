...
<div class="row mb-4">
 ...
 <p style="color:var(--tx);font-size:.96rem;line-height:1.58;margin:0;text-align:left;text-justify:auto;">{{ $overview['summary']?? 'Feedback is ready. Review the focus area and practice one answer again.' }}</p>
 </div>
 <div class="col-md-4">
 <h5 style="color:var(--tx);font-weight:800;margin-bottom:10px;"><i class="fa-solid fa-bullseye me-2" style="color:#f59e0b;"></i>Focus Area</h5>
 ...
 <h5 style="color:var(--tx);font-weight:800;margin-bottom:10px;"><i class="fa-solid fa-location-arrow me-2 text-primary"></i>Next Practice</h5>
