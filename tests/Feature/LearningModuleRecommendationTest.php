...
class LearningModuleRecommendationTest extends TestCase
{
    ...
    public function test_modules_page_focuses_on_action_modules_only(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('Open action modules that tell you what to prepare, write, rehearse, revise, and check before your interview.')
            ->assertSee('BPO Answer Basics')
            ->assertSee('Open Action Module')
            ->assertDontSee('AI Mock Interview')
            ->assertDontSee('Interview Question Bank')
    ...
    public function test_dashboard_hides_personalized_practice_plan_and_ai_recommendation_cards(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertSee('id="dashboardCoachVoice"', false)
            ->assertSee('DashboardCoachSpeechRecognition', false)
