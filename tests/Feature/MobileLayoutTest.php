...
class MobileLayoutTest extends TestCase
{
    ...
    public function test_admin_dashboard_uses_mobile_shell_for_mobile_user_agent(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertSee('--admin-topbar-control-size: 36px', false)
            ->assertSee('.mob-notification-wrap', false)
            ->assertSee('height: var(--admin-topbar-control-size)', false)
            ->assertSee('max-height: var(--admin-topbar-control-size)', false)
            ->assertSee('box-sizing: border-box', false)
            ->assertSee('padding: 0!important', false)
            ->assertSee('.mob-notification-wrap>.mob-icon-btn', false)
            ...
            ->assertSee('.mob-avatar-adm img', false)
            ...
            ->assertSee('onclick="toggleMobileNotifications(event);"', false)
            ->assertSee('id="mobNotificationDropdown"', false)
            ->assertSee('aria-hidden="true"', false)
            ->assertSee('data-admin-notif-close', false)
            ->assertSee('admin-notification-menu-open', false)
            ->assertSee('z-index: 1145!important', false)
            ->assertSee('left: max(10px, env(safe-area-inset-left, 0px))!important', false)
            ->assertSee('width: auto!important', false)
            ->assertSee('min-width: 0!important', false)
            ->assertSee('display: flex!important', false)
            ->assertSee('pointer-events: auto', false)
            ->assertSee('fetchAdminActivities', false)
            ->assertSee('setMobileNotificationLayer', false)
            ->assertSee('toggleMobileNotifications', false)
