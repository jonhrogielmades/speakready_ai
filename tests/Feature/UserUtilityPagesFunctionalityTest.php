...
class UserUtilityPagesFunctionalityTest extends TestCase
{
 ...
 public function test_modules_position_modal_filters_modules_by_user_position(): void
 {
 $user = User::factory()->create(['is_admin' => false, 'status' => 'active']);

 LearningModule::create([
 'title' => 'Data Analyst Interview Portfolio',
 'description' => 'Prepare analytics examples for a hiring conversation.',
 'status' => 'published',
 'category' => 'Role Fit',
 ...
 LearningModule::create([
 'title' => 'Software Developer Interview Portfolio',
 'description' => 'Prepare programming examples for a hiring conversation.',
 'status' => 'published',
 'category' => 'Role Fit',
 ...
 ->assertSee('Data Analyst Interview Portfolio')
 ->assertDontSee('Software Developer Interview Portfolio');
 }

 public function test_modules_position_choice_generates_related_modules_for_new_position(): void
 {
 $user = User::factory()->create(['is_admin' => false, 'status' => 'active']);
 ...
 $this->assertContains('Customer Service Representative', $module->mapped_skills);
 });
